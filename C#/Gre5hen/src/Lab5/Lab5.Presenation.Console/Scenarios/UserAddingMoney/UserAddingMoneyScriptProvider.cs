...
public class UserAddingMoneyScriptProvider : IScriptProvider
{
    private readonly IUserService _service;
    private readonly ICurrentUser _currentUser;

    public UserAddingMoneyScriptProvider(IUserService service, ICurrentUser currentUser)
    {
        _service = service;
    ...
    public bool TryGetScenario([NotNullWhen(true)] out IScript? script)
    {
        ...
        script = new UserAddingMoneyScript(_service);
